...
// if (shadow.style.backgroundColor='white') {
//   shadow.style.backgroundColor='rgba(19, 19, 29, .95)'
// }
// else{
//   shadow.style.backgroundColor='white'
// }
...
//   let h2=document.querySelector('.first_section_left h2')

//   const wasDarkmode=localStorage.getItem('darkmode')==='true';

//   localStorage.setItem('darkmode',!wasDarkmode)
//   main.classList.toggle('light_mode',!wasDarkmode)
//   main.classList.toggle('light_mode',!wasDarkmode)
//   h2.
// }
...
//  function onload() {
//   document.main.classList.toggle('light_mode', localStorage.getItem('darkmode')==='true')
//  }
